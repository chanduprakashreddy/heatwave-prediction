...
def download_and_extract():
    ...
    if "PASTE" in file_id or file_id == "17YMBYdqVsIy9tIhjMGpVuhtyrPTGVZXN":
        print("\n" + "="*60)
        print("⚠️ CRITICAL WARNING: Using placeholder Google Drive ID.")
        print("Models will NOT be downloaded. The app will fail to make predictions.")
        print("To fix this, you must train models, upload them, and set the correct 'file_id'.")
        print("="*60 + "\n")
        return
